...
import tk.maizbagwala.social.databinding.ActivityFacebookBinding;
...
//        InterstitialAdsINIT();
    ...
    private void initViews() {
        clipBoard = (ClipboardManager) activity.getSystemService(CLIPBOARD_SERVICE);
        binding.rlBackFacebook.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
    ...
    private void GetFacebookData() {
        try {
            ...
            if (host.contains("facebook.com") || host.contains("fb.")) {
        ...
        try {
            ...
            if (CopyIntent.equals("")) {
                if (!(clipBoard.hasPrimaryClip())) {
                    ...
                    if (item.getText().toString().contains("facebook.com") || item.getText().toString().contains("fb.")) {
