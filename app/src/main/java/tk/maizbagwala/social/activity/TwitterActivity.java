...
import tk.maizbagwala.social.databinding.ActivityTwitterBinding;
...
import static tk.maizbagwala.social.util.Utils.RootDirectoryTwitter;
...
//        InterstitialAdsINIT();
    ...
    private void initViews() {
        ...
        binding.rlBackTwitter.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        public void onNext(TwitterResponse twitterResponse) {
            ...
            try {
                ...
                if (twitterResponse.getVideos().get(0).getType().equals("image")) {
                    Utils.startDownload(VideoUrl, Utils.RootDirectoryTwitter, activity, getFilenameFromURL(VideoUrl, "image"));
                    binding.etText.setText("");
                } else {
                    VideoUrl = twitterResponse.getVideos().get(twitterResponse.getVideos().size() - 1).getUrl();
                    Utils.startDownload(VideoUrl, Utils.RootDirectoryTwitter, activity, getFilenameFromURL(VideoUrl, "mp4"));
                    binding.etText.setText("");
                }
